            ...
            */
            ...
            switch ($action) {
                ...
                case RoutersEnumUri::parameterEdit:
                    ...
                    break;
                case RoutersEnumUri::parameterAdd:
                    {
                        MachineMan::addControlParameters($_POST['data']);
                    }
                    break;
                case RoutersEnumUri::operatorList:
                    {
                        SoftParameterMan::operatorList(empty($_POST['data']));
                    }
                    break;
                case RoutersEnumUri::operatorEdit:
                    {
                        SoftParameterMan::editOperator($_POST['data']);
                    }
                    break;
